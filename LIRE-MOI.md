...
Syntaxe JavaScript vérifiée. **77 contrôles automatisés de logique réussis**, avec un DOM et un Canvas simulés. Ils couvrent notamment la progression, l’encaissement, les achats, le code de triche, les sorts, les nouvelles armes, les icônes, la sauvegarde et le ramassage.
