...
Le bouton **Coop en ligne · 2 joueurs** permet de créer ou rejoindre un salon privé. Le salon affiche les deux personnages, leurs pseudos, leurs apparences, leur rôle, leur arme de départ et leur état prêt/pas prêt. Chaque invité peut ajuster son apparence depuis le salon ; l’autre la voit pendant la modification. L’hôte ne peut lancer que lorsque l’invité est prêt. Chacun garde ses couleurs, accessoires et achats permanents ; l’or et le butin sont individuels. **Maintiens E près d’un partenaire à terre pendant 2 secondes pour le réanimer.**
